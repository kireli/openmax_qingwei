...
#ifndef LIMOI_VIDEOSRC01_H__
#define LIMOI_VIDEOSRC01_H__
...
} limoi_videosrc01_callbacks_t;

/** limoi_video_src component private data structure. */
struct limoi_videosrc01_priv_t
{
    limoi_videosrc01_callbacks_t callbacks; /** src callbacks. */
};


/** opaque limoi video src private data structure. */
typedef struct limoi_videosrc01_priv_t limoi_videosrc01_priv_t;

/** limoi video src component base class. */
typedef struct
{
    limoi_component_t parent;
    limoi_videosrc01_priv_t * priv; /** opaque private data. */
} limoi_videosrc01_t;

#define LIMOI_VIDEOSRC01(c) ((limoi_videosrc01_t *)OMX_COMPONENT(c))
 ...
 *        
 */
OMX_ERRORTYPE limoi_videosrc01_deinit (OMX_HANDLETYPE hComp);
 ...
 */
OMX_ERRORTYPE limoi_videosrc01_init (
 ...
 *        input video coding type/format.
 */
OMX_ERRORTYPE limoi_videosrc01_init_sync (
    OMX_HANDLETYPE * hComp,
	int bytes,
	const char * comp_name,
	const char * comp_version,
 ...
 */
int limoi_videosrc01_set_callbacks (
    OMX_HANDLETYPE hComp,
    limoi_videosrc01_callbacks_t * callbacks);

/** @} */
#endif /* LIMOI_VIDEOSRC01_COMPONENT_H__ */
