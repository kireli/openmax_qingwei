...
#ifndef LIMOI_VIDEOIVA11_COMPONENT_H__
#define LIMOI_VIDEOIVA11_COMPONENT_H__
...
typedef enum{
	VIDEO_JPEG_MODE_BYPASS,
	VIDEO_JPEG_MODE_DECODER,
	VIDEO_JPEG_MODE_NONE,
}video_JPEG_mode_e;
...
typedef struct
{
	...
	*/
    int (*main) (OMX_HANDLETYPE hComp, OMX_BUFFERHEADERTYPE * in, OMX_BUFFERHEADERTYPE * out,  void ** data);
                   

} limoi_videoIVA11_callbacks_t;

/** limoi_video_src component private data structure. */
struct limoi_videoIVA11_priv_t
{
    limoi_videoIVA11_callbacks_t callbacks; /** src callbacks. */
};


/** opaque limoi video src private data structure. */
typedef struct limoi_videoIVA11_priv_t limoi_videoIVA11_priv_t;

/** limoi video src component base class. */
typedef struct
{
    limoi_component_t parent;
    limoi_videoIVA11_priv_t * priv; /** opaque private data. */
} limoi_videoIVA11_t;

#define LIMOI_VIDEOIVA11(c) ((limoi_videoIVA11_t *)OMX_COMPONENT(c))
 ...
 *        
 */
OMX_ERRORTYPE limoi_videoIVA11_deinit (OMX_HANDLETYPE hComp);
 ...
 */
OMX_ERRORTYPE limoi_videoIVA11_init (
 ...
 *        input video coding type/format.
 */
OMX_ERRORTYPE limoi_videoIVA11_init_sync (
    OMX_HANDLETYPE * hComp,
	int bytes,
	const char * comp_name,
	const char * comp_version,
 ...
 */
int limoi_videoIVA11_set_callbacks (
    OMX_HANDLETYPE hComp,
    limoi_videoIVA11_callbacks_t * callbacks);
