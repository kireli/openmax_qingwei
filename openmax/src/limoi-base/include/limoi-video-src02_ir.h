...
#ifndef LIMOI_VIDEOSRC02_IR_H__
#define LIMOI_VIDEOSRC02_IR_H__
...
typedef enum{
	VIDEO_SRC02_MODE_IR,
	VIDEO_SRC02_MODE_SPECKLE,
	VIDEO_SRC02_MODE_NONE,
}videosrc02_ir_mode_e;
...
} limoi_videosrc02_ir_callbacks_t;

/** limoi_video_src component private data structure. */
struct limoi_videosrc02_ir_priv_t
{
    limoi_videosrc02_ir_callbacks_t callbacks; /** src callbacks. */
};


/** opaque limoi video src private data structure. */
typedef struct limoi_videosrc02_ir_priv_t limoi_videosrc02_ir_priv_t;

/** limoi video src component base class. */
typedef struct
{
    limoi_component_t parent;
    limoi_videosrc02_ir_priv_t * priv; /** opaque private data. */
} limoi_videosrc02_ir_t;

#define LIMOI_VIDEOSRC02_IR(c) ((limoi_videosrc02_ir_t *)OMX_COMPONENT(c))
 ...
 *        
 */
OMX_ERRORTYPE limoi_videosrc02_ir_deinit (OMX_HANDLETYPE hComp);
 ...
 */
OMX_ERRORTYPE limoi_videosrc02_ir_init (
 ...
 *        input video coding type/format.
 */
OMX_ERRORTYPE limoi_videosrc02_ir_init_sync (
    OMX_HANDLETYPE * hComp,
	int bytes,
	const char * comp_name,
	const char * comp_version,
 ...
 */
int limoi_videosrc02_ir_set_callbacks (
    OMX_HANDLETYPE hComp,
    limoi_videosrc02_ir_callbacks_t * callbacks);
