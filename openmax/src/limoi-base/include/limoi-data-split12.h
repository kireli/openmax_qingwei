...
#ifndef LIMOI_DATASPLIT12_COMPONENT_H__
#define LIMOI_DATASPLIT12_COMPONENT_H__

#include "limoi-component.h"
#include "component.h"

/** limoi data src component callbacks. */
typedef struct
{
...
} limoi_dataSplit12_callbacks_t;

/** limoi_video_src component private data structure. */
struct limoi_dataSplit12_priv_t
{
    limoi_dataSplit12_callbacks_t callbacks; /** src callbacks. */
};


/** opaque limoi video src private data structure. */
typedef struct limoi_dataSplit12_priv_t limoi_dataSplit12_priv_t;

/** limoi video src component base class. */
typedef struct
{
    limoi_component_t parent;
    limoi_dataSplit12_priv_t * priv; /** opaque private data. */
} limoi_dataSplit12_t;

#define LIMOI_DATA_SPLIT12(c) ((limoi_dataSplit12_t *)OMX_COMPONENT(c))
 ...
 *        
 */
OMX_ERRORTYPE limoi_dataSplit12_deinit (OMX_HANDLETYPE hComp);
 ...
 */
OMX_ERRORTYPE limoi_dataSplit12_init (
 ...
 *        input video coding type/format.
 */
OMX_ERRORTYPE limoi_dataSplit12_init_sync (
    OMX_HANDLETYPE * hComp,
	int bytes,
	const char * comp_name,
	const char * comp_version,
 ...
 */
int limoi_dataSplit12_set_callbacks ( 
    OMX_HANDLETYPE hComp,
    limoi_dataSplit12_callbacks_t *callbacks);
