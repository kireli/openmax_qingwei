...
#ifndef LIMOI_VIDEOIVA11_VPU_COMPRESS_H__
#define LIMOI_VIDEOIVA11_VPU_COMPRESS_H__
...
} videoIVA11_vpu_compress_private_t;

#define LIMOI_VIDEOIVA11_VPU_COMPRESS(c) ((videoIVA11_vpu_compress_private_t *)OMX_COMPONENT(c))
