...
#ifndef LIMOI_VIDEOIVA20_AE_H__
#define LIMOI_VIDEOIVA20_AE_H__
...
} videoIVA20_ae_private_t;

#define LIMOI_VIDEOIVA20_AE(c) ((videoIVA20_ae_private_t *)OMX_COMPONENT(c))
