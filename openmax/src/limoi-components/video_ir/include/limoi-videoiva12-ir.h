...
#ifndef LIMOI_VIDEOIVA12_IR_H__
#define LIMOI_VIDEOIVA12_IR_H__
...
} videoIVA12_ir_private_t;

#define LIMOI_VIDEOIVA12_IR(c) ((videoIVA12_ir_private_t *)OMX_COMPONENT(c))
