...
#ifndef LIMOI_VIDEOSRC_VISCAP_H__
#define LIMOI_VIDEOSRC_VISCAP_H__
...
} videosrc_viscap_private_t;

#define LIMOI_VIDEOSRC_VISCAP(c) ((videosrc_viscap_private_t *)OMX_COMPONENT(c))

/** @} */
#endif /* LIMOI_VIDEOSRC_VISCAP_H__ */
