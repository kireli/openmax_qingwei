...
#ifndef LIMOI_VIDEOSRC_VISSTREAM_H__
#define LIMOI_VIDEOSRC_VISSTREAM_H__
...
} videosrc_visstream_private_t;

#define LIMOI_VIDEOSRC_VISSTREAM(c) ((videosrc_visstream_private_t *)OMX_COMPONENT(c))

/** @} */
#endif /* LIMOI_VIDEOSRC_VISSTREAM_H__ */
