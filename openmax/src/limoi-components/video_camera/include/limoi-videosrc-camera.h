...
#ifndef LIMOI_VIDEOSRC_CAMERA_H__
#define LIMOI_VIDEOSRC_CAMERA_H__
...
typedef struct
{
    limoi_videosrc_t parent; /** inherit limoi video src. */

} videosrc_camera_private_t;

#define LIMOI_VIDEOSRC_CAMERA(c) ((videosrc_camera_private_t *)OMX_COMPONENT(c))
