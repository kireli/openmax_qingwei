...
#ifndef LIMOI_VIDEOSRC_IRSTREAM_H__
#define LIMOI_VIDEOSRC_IRSTREAM_H__
...
} videosrc_irstream_private_t;

#define LIMOI_VIDEOSRC_IRSTREAM(c) ((videosrc_irstream_private_t *)OMX_COMPONENT(c))

/** @} */
#endif /* LIMOI_VIDEOSRC_IRSTREAM_H__ */
