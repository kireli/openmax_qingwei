...
#ifndef LIMOI_VIDEOSRC_TOFCAP_H__
#define LIMOI_VIDEOSRC_TOFCAP_H__
...
} videosrc_tofcap_private_t;

#define LIMOI_VIDEOSRC_TOFCAP(c) ((videosrc_tofcap_private_t *)OMX_COMPONENT(c))

/** @} */
#endif /* LIMOI_VIDEOSRC_TOF_COMMON_H__ */
