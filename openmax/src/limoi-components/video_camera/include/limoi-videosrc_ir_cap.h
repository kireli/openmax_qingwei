...
#ifndef LIMOI_VIDEOSRC_IRCAP_H__
#define LIMOI_VIDEOSRC_IRCAP_H__
...
} videosrc_ircap_private_t;

#define LIMOI_VIDEOSRC_IRCAP(c) ((videosrc_ircap_private_t *)OMX_COMPONENT(c))
