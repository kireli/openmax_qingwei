...
#ifndef LIMOI_VIDEOIVA11_TEST_H__
#define LIMOI_VIDEOIVA11_TEST_H__
...
} videoIVA11_test_private_t;

#define LIMOI_VIDEOIVA11_TEST(c) ((videoIVA11_test_private_t *)OMX_COMPONENT(c))
