...
#ifndef LIMOI_VIDEOIVA01_TEST_H__
#define LIMOI_VIDEOIVA01_TEST_H__
...
typedef struct
{
    limoi_videoIVA01_t parent; /** inherit limoi video src. */

} videoIVA01_test_private_t;

#define LIMOI_VIDEOIVA01_TEST(c) ((videoIVA01_test_private_t *)OMX_COMPONENT(c))
