...
#ifndef LIMOI_VIDEOIVA10_RECO_TOF_H__
#define LIMOI_VIDEOIVA10_RECO_TOF_H__
...
} videoIVA10_reco_tof_private_t;

#define LIMOI_VIDEOIVA10_RECO_TOF(c) ((videoIVA10_reco_tof_private_t *)OMX_COMPONENT(c))
