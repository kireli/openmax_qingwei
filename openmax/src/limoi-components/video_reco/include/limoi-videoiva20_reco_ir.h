...
#ifndef LIMOI_VIDEOIVA20_RECO_IR_H__
#define LIMOI_VIDEOIVA20_RECO_IR_H__
...
} videoIVA20_reco_ir_private_t;

#define LIMOI_VIDEOIVA20_RECO_IR(c) ((videoIVA20_reco_ir_private_t *)OMX_COMPONENT(c))
