...
#ifndef LIMOI_VIDEOIVA10_RECO_VIS_H__
#define LIMOI_VIDEOIVA10_RECO_VIS_H__
...
} videoIVA10_reco_vis_private_t;

#define LIMOI_VIDEOIVA10_RECO_VIS(c) ((videoIVA10_reco_vis_private_t *)OMX_COMPONENT(c))
