...
#ifndef LIMOI_VIDEOIVA20_RECO_VIS_H__
#define LIMOI_VIDEOIVA20_RECO_VIS_H__
...
} videoIVA20_reco_vis_private_t;

#define LIMOI_VIDEOIVA20_RECO_VIS(c) ((videoIVA20_reco_vis_private_t *)OMX_COMPONENT(c))
