...
#ifndef LIMOI_VIDEOIVA11_RECO_IR_H__
#define LIMOI_VIDEOIVA11_RECO_IR_H__
...
} videoIVA11_reco_ir_private_t;

#define LIMOI_VIDEOIVA11_RECO_IR(c) ((videoIVA11_reco_ir_private_t *)OMX_COMPONENT(c))
