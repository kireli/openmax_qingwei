...
#ifndef LIMOI_VIDEOIVA10_RECO_IR_H__
#define LIMOI_VIDEOIVA10_RECO_IR_H__
...
} videoIVA10_reco_ir_private_t;

#define LIMOI_VIDEOIVA10_RECO_IR(c) ((videoIVA10_reco_ir_private_t *)OMX_COMPONENT(c))
