...
#ifndef LIMOI_VIDEOIVA40_RECO_H__
#define LIMOI_VIDEOIVA40_RECO_H__
...
typedef struct
{
    limoi_videoIVA40_t parent; /** inherit limoi video src. */

} videoIVA40_reco_private_t;

#define LIMOI_VIDEOIVA40_RECO(c) ((videoIVA40_reco_private_t *)OMX_COMPONENT(c))
