...
#ifndef LIMOI_VIDEOIVA12_VIS_H__
#define LIMOI_VIDEOIVA12_VIS_H__
...
typedef struct
{
    limoi_videoIVA12_t parent; /** inherit limoi video src. */

} videoIVA12_vis_private_t;

#define LIMOI_VIDEOIVA12_VIS(c) ((videoIVA12_vis_private_t *)OMX_COMPONENT(c))
