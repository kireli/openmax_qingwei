...
#ifndef LIMOI_VIDEOIVA10_VIS_DETECT_H__
#define LIMOI_VIDEOIVA10_VIS_DETECT_H__
...
} videoIVA10_vis_detect_private_t;

#define LIMOI_VIDEOIVA10_VIS_DETECT(c) ((videoIVA10_vis_detect_private_t *)OMX_COMPONENT(c))
