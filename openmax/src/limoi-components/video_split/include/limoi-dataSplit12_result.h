...
#ifndef LIMOI_DATASPLIT12_RESULT_H__
#define LIMOI_DATASPLIT12_RESULT_H__
...
typedef struct
{
    limoi_dataSplit12_t parent; /** inherit limoi video src. */

} dataSplit12_result_private_t;

#define LIMOI_DATA_SPLIT12_RESULT(c) ((dataSplit12_result_private_t *)OMX_COMPONENT(c))
