...
#ifndef LIMOI_VIDEOSPLIT12_H__
#define LIMOI_VIDEOSPLIT12_H__
...
typedef struct
{
    limoi_videoSplit12_t parent; /** inherit limoi video src. */

} videoSplit12_private_t;

#define LIMOI_VIDEO_SPLIT12(c) ((videoSplit12_private_t *)OMX_COMPONENT(c))
