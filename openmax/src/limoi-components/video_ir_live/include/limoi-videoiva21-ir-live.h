...
#ifndef LIMOI_VIDEOIVA21_IR_LIVE_H__
#define LIMOI_VIDEOIVA21_IR_LIVE_H__
...
typedef struct
{
    limoi_videoIVA21_t parent; /** inherit limoi video src. */

} videoIVA21_ir_live_private_t;

#define LIMOI_VIDEOIVA21_IR_LIVE(c) ((videoIVA21_ir_live_private_t *)OMX_COMPONENT(c))
