...
#ifndef LIMOI_VIDEOIVA11_3D_H__
#define LIMOI_VIDEOIVA11_3D_H__
...
} videoIVA11_3d_private_t;

#define LIMOI_VIDEOIVA11_3D(c) ((videoIVA11_3d_private_t *)OMX_COMPONENT(c))
