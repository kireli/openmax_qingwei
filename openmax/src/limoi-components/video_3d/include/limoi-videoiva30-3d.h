...
#ifndef LIMOI_VIDEOIVA30_3D_H__
#define LIMOI_VIDEOIVA30_3D_H__
...
typedef struct
{
    limoi_videoIVA30_t parent; /** inherit limoi video src. */

} videoIVA30_3d_private_t;

#define LIMOI_VIDEOIVA30_3D(c) ((videoIVA30_3d_private_t *)OMX_COMPONENT(c))
