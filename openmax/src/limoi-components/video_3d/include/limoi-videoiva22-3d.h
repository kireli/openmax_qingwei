...
#ifndef LIMOI_VIDEOIVA22_3D_H__
#define LIMOI_VIDEOIVA22_3D_H__
...
typedef struct
{
    limoi_videoIVA22_t parent; /** inherit limoi video src. */

} videoIVA22_3d_private_t;

#define LIMOI_VIDEOIVA22_3D(c) ((videoIVA22_3d_private_t *)OMX_COMPONENT(c))
