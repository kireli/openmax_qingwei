...
#ifndef LIMOI_VIDEOIVA20_3D_H__
#define LIMOI_VIDEOIVA20_3D_H__
...
} videoIVA20_3d_private_t;

#define LIMOI_VIDEOIVA20_3D(c) ((videoIVA20_3d_private_t *)OMX_COMPONENT(c))
