...
#define limq_create(entry_bytes, max_entries, name, sem_enable) \
    limq_create_ext(entry_bytes, max_entries, name, NULL, sem_enable)
...
limq_handle_t limq_create_ext (
    ...
    int max_entries,
    const char * name,
    limq_compare_cb_t compare, int sem_enabel);
...
int limq_dequeue_get_count(limq_handle_t que);
