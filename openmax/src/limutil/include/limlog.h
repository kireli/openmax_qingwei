...
#define lim_malloc(size) aos_malloc(size)
#define lim_calloc(num,size) aos_calloc(num,size)
#define lim_free(p) aos_free(p)
#define VERSION "0.0.2"

char *lim_strdup(const char *s);
char *lim_strndup(const char *s, int len);
...
//#define LIMFATAL(fmt, arg...) 
//#define LIMERR(fmt, arg...) 
